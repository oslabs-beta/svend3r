<script>
  ...
  $: marginRight = $BarChartDocs[2].value; // the right margin, in pixels //*****Remove reactivepermalink for production use
  $: marginBottom = $BarChartDocs[3].value; // the bottom margin, in pixels //*****Remove reactivepermalink for production use
  $: marginLeft = $BarChartDocs[4].value; // the left margin, in pixels //*****Remove reactivepermalink for production use
  $: width = $BarChartDocs[5].value; // the outer width of the chart, in pixels //*****Remove reactivepermalink for production use
  $: height = $BarChartDocs[6].value; // the outer height of the chart, in pixels //*****Remove reactivepermalink for production use
  $: xPadding = $BarChartDocs[7].value; // amount of x-range to reserve to separate bars //*****Remove reactivepermalink for production use
  $: yFormat = $BarChartDocs[8].value; // a format specifier string for the y-axis //*****Remove reactivepermalink for production use
  $: yLabel = $BarChartDocs[9].value; // a label for the y-axis //*****Remove reactivepermalink for production use
  $: color = $BarChartDocs[10].value; // bar fill color //*****Remove reactivepermalink for production use
  $: yScalefactor = $BarChartDocs[11].value; //y-axis number of values //*****Remove reactivepermalink for production use
