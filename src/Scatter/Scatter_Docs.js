...
const pieChartDocs = [
  ...
  },
  {
    ...
    value: 'kg',
    dataType: 'String',
    description: 'The format specifier string for the x-axis.',
    defaultValue: 'kg',
  },
  {
    variable: 'yFormat',
    value: 'cm',
    dataType: 'String',
    description: 'The format specifier string for the y-axis.',
    defaultValue: 'cm',
  },
  {
    variable: 'xScalefactor',
    value: 10,
    dataType: 'Number',
    description: 'The x-axis number of values.',
    defaultValue: 10,
    min: 2,
    max: 20,
  },
  {
    ...
    value: 12,
    dataType: 'Number',
    description: 'The y-axis number of values.',
    defaultValue: 12,
    min: 2,
    max: 20,
  },
  {
    variable: 'colors',
    value: ['red', 'orange', 'green', 'blue', 'purple'],
    dataType: 'Array',
    description: 'The fill colors for each dot group.  The length of colors MUST match the data set array length.',
    defaultValue: ['red', 'orange', 'green', 'blue', 'purple'],
  },
  {
    variable: 'filled',
    value: true,
    dataType: 'Boolean',
    description: 'Toggle dots being filled or outlined.',
    defaultValue: true,
  },
  {
